...
listItem.forEach((li)=>{
    li.addEventListener('click', (e)=>{
        ...
        if(Array.from(itemContent)[index].classList.contains('item__content--enabled')){
            Array.from(itemContent)[index].classList.remove('item__content--enabled');
            Array.from(itemContent)[index].classList.add('item__content--disabled');
        }else{
            Array.from(itemContent)[index].classList.add('item__content--enabled');
        ...
        if(Array.from(itemDots)[index].classList.contains('item__dot-disabled')){
            ...
            Array.from(itemDots)[index].classList.add('item__dot-enabled');
        }else{
            Array.from(itemDots)[index].classList.add('item__dot-disabled');
            Array.from(itemDots)[index].classList.remove('item__dot-enabled');
        }
    })
})